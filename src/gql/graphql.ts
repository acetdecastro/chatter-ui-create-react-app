...
export type MessageFragmentFragment = { __typename?: 'Message', _id: string, content: string, createdAt: any, seen: boolean, userId: string, chatId: string };
...
export type CreateMessageMutation = { __typename?: 'Mutation', createMessage: { __typename?: 'Message', _id: string, content: string, createdAt: any, seen: boolean, userId: string, chatId: string } };
...
export type MessagesQuery = { __typename?: 'Query', messages: Array<{ __typename?: 'Message', _id: string, content: string, createdAt: any, seen: boolean, userId: string, chatId: string }> };
...
export type MessageCreatedSubscription = { __typename?: 'Subscription', messageCreated: { __typename?: 'Message', _id: string, content: string, createdAt: any, seen: boolean, userId: string, chatId: string } };
